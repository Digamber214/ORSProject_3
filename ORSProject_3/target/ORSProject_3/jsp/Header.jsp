...
<body>
	...
	<div class="header">
		<nav class="navbar navbar-expand-lg navbar-light bg-secondary">
		 ...
		 <img src="<%=ORSView.APP_CONTEXT%>/img/custom.png" width="90px" height="50px"></a>
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item"
							href="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>"><i class="	fa fa-file-alt"></i>Marksheet Merit List</a>
					</div></li>
